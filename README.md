...
- 🌐 **Host/IP Configuration** - Custom IP/domain for online hosting (NEW v3.16.0)
...
- 🎯 **Create & Add** - Create backend servers directly in proxy interface (NEW v3.15.0)
- 🔑 **Auto-Configuration** - Automatic forwarding secret sync for Velocity (NEW v3.15.0)
- 🗺️ **Network Topology** - Interactive drag-drop visualization
- 🎨 **Server Templates** - 6+ pre-configured server presets
